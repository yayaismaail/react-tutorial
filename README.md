...
**[React Todo App]** is a project that allows users to add todo tasks, edit them, mark them as finished, as well as delete them
...
- **[Addition of the background images and icons]**
